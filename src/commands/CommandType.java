...
public enum CommandType {
    ...
    showPodcasts, removeAlbum, changePage, removePodcast, removeEvent, getTop5Albums, getTop5Artists,
    wrapped, buyPremium, cancelPremium, adBreak, subscribe, getNotifications, buyMerch, seeMerch,
    updateRecommendations, previousPage, topAlbums, topSongs, topFans, listeners, topEpisodes, songRevenue,
    merchRevenue, ranking, mostProfitableSong, loadRecommendations, endProgram, nextPage
}
